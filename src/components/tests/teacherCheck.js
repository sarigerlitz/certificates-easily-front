...
export default function CheckTest() {
    ...
    async function saveMark() {
        await axios.put('https://certificates-easily-back.onrender.com/api/studentToTest', { studentId: studentTest.studentId, mark: mark, subjectId: test.subjectId, id: id, isTeacher: true })
            .then(r => r.data)
    ...
    useEffect(() => {
        axios.get('https://certificates-easily-back.onrender.com/api/studentToTest/test/' + id)
            .then(r => r.data)
            .then(res => {
                setStudentTest(res.test)
                setName(res.name)
                axios.get('https://certificates-easily-back.onrender.com/api/tests/test/' + res.test.testId)
